...
import com.plataforma.cursos.controller.docs.FavoritoControllerDocs;
...
@CrossOrigin
public class FavoritoController implements FavoritoControllerDocs {
    ...
    public ResponseEntity<Void> adicionar(@PathVariable Long cursoId, Authentication authentication) {
        ...
        favoritoService.adicionar(usuarioId, cursoId);
    ...
    public ResponseEntity<Void> remover(@PathVariable Long cursoId, Authentication authentication) {
        ...
        favoritoService.remover(usuarioId, cursoId);
    ...
    public ResponseEntity<Boolean> existe(@PathVariable Long cursoId, Authentication authentication) {
        ...
        return ResponseEntity.ok(favoritoService.existe(usuarioId, cursoId));
    }
}